 ...
 * * `unreachable` - Apply will not be run.
 */
export type status3 = 'pending' | 'queued' | 'running' | 'finished' | 'canceled' | 'errored' | 'unreachable';
 ...
 * * `unreachable` - The cost estimate will not run.
 */
export type status5 = 'pending' | 'queued' | 'finished' | 'canceled' | 'errored' | 'unreachable';
 ...
 * `error-message` contains the details.
 */
export type status7 = 'no_version_tags' | 'pending' | 'setup_complete' | 'errored';
 ...
 * Attribute `error-message` contains the details.
 */
export type status8 = 'not_uploaded' | 'pending' | 'ok' | 'errored' | 'pending_delete';
