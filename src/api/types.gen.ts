 ...
 * * `offline` - API server hasn't seen the agent's heartbeat for 30 seconds.
 */
export type status2 = 'idle' | 'busy' | 'offline' | 'errored';
 ...
 * * `errored` - uploaded files post processing failed. Attribute `error-message` contains the details.
 */
export type status4 = 'errored' | 'pending' | 'uploaded';
 ...
 * Status of integration.
 */
export type status6 = 'active' | 'disabled' | 'failed';
...
export type ModuleVersion = {
  attributes: {
    ...
    readonly inputs?: Array<
      RegistryInputOptional | RegistryInputRequired
    > | null;
    /**
 ...
 * * `errored` - synchronization has failed. Attribute `error-message` contains the details.
 */
export type status10 = 'fetching' | 'active' | 'errored';
 ...
 * Provider configuration status. Can be: `active`, `errored`.
 */
export type status11 = 'active' | 'errored';
...
export const security_digest_algorithm = {
    HTTP___WWW_W3_ORG_2001_04_XMLENC_SHA256:
    'http://www.w3.org/2001/04/xmlenc#sha256',
    HTTP___WWW_W3_ORG_2001_04_XMLDSIG_MORE_SHA384:
    'http://www.w3.org/2001/04/xmldsig-more#sha384',
    HTTP___WWW_W3_ORG_2001_04_XMLENC_SHA512:
    'http://www.w3.org/2001/04/xmlenc#sha512',
} as const;
 ...
 * Allows the authn comparison parameter to be set.
 */
export type security_requested_authn_context_comparison =
  | 'exact'
  | 'minimum'
  | 'better'
  | 'maximum';
...
export const security_signature_algorithm = {
    HTTP___WWW_W3_ORG_2001_04_XMLDSIG_MORE_RSA_SHA256:
    'http://www.w3.org/2001/04/xmldsig-more#rsa-sha256',
    HTTP___WWW_W3_ORG_2001_04_XMLDSIG_MORE_RSA_SHA384:
    'http://www.w3.org/2001/04/xmldsig-more#rsa-sha384',
    HTTP___WWW_W3_ORG_2001_04_XMLDSIG_MORE_RSA_SHA512:
    'http://www.w3.org/2001/04/xmldsig-more#rsa-sha512',
} as const;
 ...
 * * `active` - Available to use.
 */
export type status14 = 'pending' | 'failed' | 'active';
